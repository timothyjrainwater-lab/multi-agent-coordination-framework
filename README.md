...
| [Research Artifact Registry](patterns/RESEARCH_ARTIFACT_REGISTRY.md) | Research documents accumulate as dead artifacts — tokens spent, value not extracted | Master registry with sweep lifecycle tracking; section ledger format ensures every artifact produces backlog entries or explicit REFERENCE-ONLY decisions |
